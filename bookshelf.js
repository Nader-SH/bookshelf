...
function renderBook(book) {
    ...
    bookTit.src = book.title;
    bookTit.innerText = book.title;
    ...
    bookp.innerText = book.author;


    let bookwork = document.createElement('p');
    bookwork.innerText = book.work;
...
function guardarNumeros() {
    ...
    titleVar = document.getElementById('title').value;
    authorVar = document.getElementById('author').value;
    workVar = document.getElementById('work').value;
    imageVar = document.getElementById('image').value;
